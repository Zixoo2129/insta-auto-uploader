...
from caption_formatter import format_caption # Changed here
...
def handle_post(file_path, caption, is_reel=False, cover_path=None):
    ...
    final_caption = format_caption(caption) # Function call changed here
    ...
    if is_reel:
        ...
        upload_image(processed_file, final_caption) # Correct indentation
